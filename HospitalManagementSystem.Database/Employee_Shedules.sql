Create database [Employee_Shedules] 
Go

Use [Employee_Shedules]
Go
...
(
	...
	Constraint [FK-Has-Role-to-Employees] Foreign key ([EmployeesId]) references [Employee]([Id]),
	
	Constraint [FK-Role-Has-to-Roles] Foreign key ([PositionId]) references [Position]([Id]),
)
Go
...
(
	...
	Constraint [FK-In-Department-to-Employees] Foreign key ([EmployeesId]) references [Employee]([Id]),
